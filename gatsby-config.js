...
module.exports = {
    ...
    siteMetadata: {
        ...
        keywords: "HTML, CSS, Sass, Javascript, React, Gatsby, GraphQL, Python, Java, Python, C#, Unity" +
            "Alexandre, Stang, Alexandre Stang, Portfolio, UX, UI, Designer, Intégrateur, Web, Front-end, Illustrateur, " +
            "Collège, Montpetit, Adobe, Photoshop, Illustrator, XD, Figma, UQAT, Université de Montréal, UDEM, Montréal, " +
            "Québec, Canada",
        contact: {
